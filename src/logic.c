...
void ChangeMode(mode_t select_mode, logic_task_args_t args) {
    ...
    switch (mode) {
        case MODO_SIN_AJUSTAR:    flash = FLASH_ALL;        break;
        case MODO_MINUTOS:        flash = FLASH_MINUTES;    break;
        case MODO_HORAS:          flash = FLASH_HOURS;      break;
        case MODO_NORMAL:         flash = FLASH_NONE;       break;
        case MODO_MINUTOS_ALARMA: flash = FLASH_MINUTES;    break;
        case MODO_HORAS_ALARMA:   flash = FLASH_HOURS;      break;
        default: return;
    }
